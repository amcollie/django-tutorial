...
class QuestionIndexViewTest(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """ 
        Even if past and future questions exist, only past questions are displayed on the index
        """
        question = create_question(question_text='Past question.', days=-30)
...
class QuestionDetailViewTest(TestCase):
    def test_future_question(self):
        """
        The default view of a question with a pub_date in the future 
    ...
    def test_past_question(self):
        """
        The default view of a question with a pub_date in the past 
        dispalys the question text.
        """
